(function ($) {
    ...
    $(function () {
        ...
        if ($("#komparasiTemuan").length) {
            var komparasiTemuanChart = document
                .getElementById("komparasiTemuan")
                .getContext("2d");
            ...
            document.getElementById("marketing-overview-legend").innerHTML =
                komparasiTemuan.generateLegend();
        }
        if ($("#komparasiTemuan-dark").length) {
            var komparasiTemuanChartDark = document
                .getElementById("komparasiTemuan-dark")
                .getContext("2d");
            ...
            document.getElementById("marketing-overview-legend").innerHTML =
                komparasiTemuanDark.generateLegend();
        }
        if ($("#doughnutChart").length) {
            ...
            var doughnutPieData = {
                ...
                labels: ["Trackbed", "Sleeper", "Rail Defect", "Lintas"],
            };
