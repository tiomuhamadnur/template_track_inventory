...
@section('sub-title')
    <title>Data Line Depo | CPWTM</title>
@endsection

@section('sub-content')
    <h4>Master Data Depo > Line</h4>
    <div class="row">
        <div class="col-sm-12">
            <div class="home-tab">
                ...
                <div class="col-lg-12 grid-margin stretch-card mt-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="{{ route('depoline.create') }}" class="btn btn-outline-dark btn-lg" type="button">Add
                                Data</a>
                                    ...
                                    <tbody>
                                        @foreach ($line_depo as $item)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group">
                                                        <a href="{{ route('depoline.edit', $item->id) }}" type="button"
