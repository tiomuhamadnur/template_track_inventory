...
@section('sub-title')
    <title>Data Vendor | CPWTM</title>
@endsection

@section('sub-content')
    <h4>Master Data > Vendor</h4>
    <div class="row">
        <div class="col-sm-12">
            <div class="home-tab">
                ...
                <div class="col-lg-12 grid-margin stretch-card mt-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="{{ route('vendor.create') }}" class="btn btn-outline-dark btn-lg" type="button">Add
                                Data</a>
                                    ...
                                    <tbody>
                                        @foreach ($vendor as $item)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group">
                                                        <a href="{{ route('vendor.edit', $item->id) }}" type="button"
