...
@section('sub-title')
    <title>Data Departement | CPWTM</title>
@endsection

@section('sub-content')
    <h4>Master Data > Departement</h4>
    <div class="row">
        <div class="col-sm-12">
            <div class="home-tab">
                ...
                <div class="col-lg-12 grid-margin stretch-card mt-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="{{ route('departement.create') }}" class="btn btn-outline-dark btn-lg" type="button">Add
                                Data</a>
                                    ...
                                    <tbody>
                                        @foreach ($departement as $item)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group">
                                                        <a href="{{ route('departement.edit', $item->id) }}" type="button"
            ...
            <div class="modal-content">
                <div class="modal-body p-2">
                    ...
                    <div class="px-5 pb-8 text-center mt-3">
                        <form action="{{ route('departement.delete') }}" method="POST">
                            @csrf
                            @method('delete')
