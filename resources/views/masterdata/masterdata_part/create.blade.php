...
@section('sub-content')
    <h5>Master Data > Part > Create Data</h5>
    <div class="row">
        <div class="col-sm-12">
            <div class="home-tab">
                ...
                <div class="col-lg-12 grid-margin stretch-card mt-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="forms-sample" action="{{ route('depopart.store') }}" method="POST">
                                @csrf
                                @method('post')
                                ...
                                <a href="{{ route('masterdata_part.index') }}" class="btn btn-light">Cancel</a>
                            </form>
                        </div>
                    </div>
                </div>
