                ...
                <div class="col-lg-12 grid-margin stretch-card mt-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="{{ route('masterdata_trackbed.create') }}" class="btn btn-outline-dark btn-lg" type="button">Add
                                Data</a>
    ...
    <div class="col-lg-4 col-md-6">
        ...
        <div id="import-file-modal" class="modal fade" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form action="{{ route('masterdata_trackbed.import') }}" method="POST" enctype="multipart/form-data">
                        <div class="modal-body">
                            @csrf
                            @method('post')
                            <div class="modal-header">
