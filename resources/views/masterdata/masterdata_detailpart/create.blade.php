...
@section('sub-content')
    <h5>Master Data > Detail Part > Create Data</h5>
    <div class="row">
        <div class="col-sm-12">
            <div class="home-tab">
                ...
                <div class="col-lg-12 grid-margin stretch-card mt-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="forms-sample" action="{{ route('masterdata_detail-part.store') }}" method="POST">
                                @csrf
                                @method('post')
                                ...
                                <a href="{{ route('masterdata_detail-part.index') }}" class="btn btn-light">Cancel</a>
                            </form>
                        </div>
                    </div>
                </div>
