        ...
        <div class="col-sm-12">
            <div class="home-tab">
                ...
                <div class="col-lg-12 grid-margin stretch-card mt-3">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Data Defect</h4>
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton1">
                                ...
                                <a class="dropdown-item" href="{{ route('defect-civil.export.excel') }}"
        ...
        <div class="modal-dialog modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="form_add" action="{{ route('defect-civil.store') }}" method="POST">
                        @csrf
                        @method('post')
                        <div class="form-group">
                            <label class="form-label">Nama Defect</label>
                            <input type="text" name="name" class="form-control" placeholder="nama defect"
                                autocomplete="off" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Code Defect</label>
                            <input type="text" name="code" class="form-control" placeholder="code defect (optional)"
                                autocomplete="off">
                        </div>
                    </form>
                </div>
    ...
    <div class="modal fade" id="ModalUpdate" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="form_update" action="{{ route('defect-civil.update') }}" method="POST">
                        @csrf
                        @method('put')
                        <div class="form-group">
                            <label class="form-label">Nama Defect</label>
                            ...
                            <input type="text" name="name" id="name_update" class="form-control"
                                placeholder="nama defect" autocomplete="off" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Code Defect</label>
                            <input type="text" name="code" id="code_update" class="form-control"
                                placeholder="code defect (optional)" autocomplete="off">
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
            ...
            <div class="modal-content">
                <div class="modal-body p-2">
                    ...
                    <div class="px-5 pb-8 text-center mt-3">
                        <form action="{{ route('defect-civil.delete') }}" method="POST">
                            @csrf
                            @method('delete')
