...
@section('sub-title')
    <title>Data Part | CPWTM</title>
@endsection

@section('sub-content')
    <h4>Master Data > Part</h4>
    <div class="row">
        <div class="col-sm-12">
            <div class="home-tab">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton1">
                                ...
                                <a class="dropdown-item" href="{{ route('part-civil.export.excel') }}"
        ...
        <div class="modal-dialog modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="form_add" action="{{ route('part-civil.store') }}" method="POST">
                        @csrf
                        @method('post')
                        <div class="form-group">
                            <label class="form-label">Nama Part</label>
                            <input type="text" name="name" class="form-control" placeholder="nama part"
                                autocomplete="off" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Code Part</label>
                            <input type="text" name="code" class="form-control" placeholder="code part (optional)"
                                autocomplete="off">
                        </div>
                    </form>
                </div>
    ...
    <div class="modal fade" id="ModalUpdate" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="form_update" action="{{ route('part-civil.update') }}" method="POST">
                        @csrf
                        @method('put')
                        <div class="form-group">
                            <label class="form-label">Nama Part</label>
                            ...
                            <input type="text" name="name" id="name_update" class="form-control"
                                placeholder="nama part" autocomplete="off" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Code Part</label>
                            <input type="text" name="code" id="code_update" class="form-control"
                                placeholder="code part (optional)" autocomplete="off">
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
            ...
            <div class="modal-content">
                <div class="modal-body p-2">
                    ...
                    <div class="px-5 pb-8 text-center mt-3">
                        <form action="{{ route('part-civil.delete') }}" method="POST">
                            @csrf
                            @method('delete')
