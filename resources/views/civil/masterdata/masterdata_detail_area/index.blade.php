...
@section('sub-title')
    <title>Data Detail Area | CPWTM</title>
@endsection

@section('sub-content')
    <h4>Master Data > Detail Area</h4>
    <div class="row">
        <div class="col-sm-12">
            <div class="home-tab">
                ...
                <div class="col-lg-12 grid-margin stretch-card mt-3">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Data Detail Area</h4>
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton1">
                                ...
                                <a class="dropdown-item" href="{{ route('detail-area.export.excel') }}"
        ...
        <div class="modal-dialog modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="form_add" action="{{ route('detail-area.store') }}" method="POST">
                        @csrf
                        @method('post')
            ...
            <div class="modal-content">
                <div class="modal-body p-2">
                    ...
                    <div class="px-5 pb-8 text-center mt-3">
                        <form action="{{ route('detail-area.delete') }}" method="POST">
                            @csrf
                            @method('delete')
