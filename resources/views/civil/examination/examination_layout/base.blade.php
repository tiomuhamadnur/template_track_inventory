...
<body>
    <div class="container-scroller">
        ...
        @include('civil.examination.examination_layout.header')

        <div class="container-fluid page-body-wrapper">

            @include('civil.examination.examination_layout.sidebar')
            ...
            <div class="main-panel">
                ...
                @include('civil.examination.examination_layout.footer')
