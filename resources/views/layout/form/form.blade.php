...
<head>
    ...
    <link href="{{ asset('assets/images/exods.png') }}" rel="shortcut icon">
    ...
    <!-- Icons font CSS-->
    <link href="{{ asset('assets/form/vendor/mdi-font/css/material-design-iconic-font.min.css') }}" rel="stylesheet"
        media="all">
    <link href="{{ asset('assets/form/vendor/font-awesome-4.7/css/font-awesome.min.css') }}" rel="stylesheet"
        media="all">
...
<body>
    ...
    @include('layout.form.modal_notification')
