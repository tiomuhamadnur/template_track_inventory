...
@section('sub-title')
    <title>Data Relasi Defect | TCSM</title>
@endsection

@section('sub-content')
    <h4>Master Data Mainline > Relasi Defect</h4>
    <div class="row">
        <div class="col-sm-12">
            <div class="home-tab">
                ...
                <div class="col-lg-12 grid-margin stretch-card mt-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="{{ route('transDefect.create') }}" class="btn btn-outline-dark btn-lg" type="button">Add
                                Data</a>
                                    ...
                                    <tbody>
                                        @foreach ($part as $item)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group">
                                                        <a href="{{ route('transDefect.edit', $item->id) }}" type="button"
            ...
            <div class="modal-content">
                <div class="modal-body p-2">
                    ...
                    <div class="px-5 pb-8 text-center mt-3">
                        <form action="{{ route('transDefect.delete') }}" method="POST">
                            @csrf
                            @method('delete')
