...
@section('sub-content')
    <h4>Master Data Mainline > Defect</h4>
    <div class="row">
        <div class="col-sm-12">
            <div class="home-tab">
                ...
                <div class="col-lg-12 grid-margin stretch-card mt-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="{{ route('defect.create') }}" class="btn btn-outline-dark btn-lg" type="button">Add
                                Data</a>
            ...
            <div class="modal-content">
                <div class="modal-body p-2">
                    ...
                    <div class="px-5 pb-8 text-center mt-3">
                        <form action="{{ route('defect.delete') }}" method="POST">
                            @csrf
                            @method('delete')
