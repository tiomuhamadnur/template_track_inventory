        ...
        return [
            ...
            'master' => [
                ...
                'sub_menu' => [
                    ...
                    'transDefect' => [
                        'icon' => 'tag',
                        'route_name' => 'transDefect.index',
                        'params' => [
                            'layout' => 'side-menu',
                        ],
                        'title' => 'Relasi Defects',
                    ],
                    'mainline' => [
                        'icon' => 'wind',
                        'route_name' => 'mainline.index',
                        'params' => [
                            'layout' => 'side-menu',
                        ],
                        'title' => 'Track Bed',
            ...
            'activity' => [
                ...
                'sub_menu' => [
                    'temuan' => [
                        'icon' => 'slack',
                        'route_name' => 'temuan.index',
                        'params' => [
                            'layout' => 'side-menu',
                        ],
                        'title' => 'Summary Temuan',
                    ],
                    'accelerometer' => [
                        'icon' => 'codesandbox',
                        'route_name' => 'accelerometer.index',
                        'params' => [
                            'layout' => 'side-menu',
                        ],
                        'title' => 'Accelerometer',
